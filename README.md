# vibrant-band-website

A band website with the follwing desing principles 
...
```sh
git clone https://github.com/GPT-Engineer-App/vibrant-band-website.git
cd vibrant-band-website
npm i
```
